           ...
           $.each(Student.records,function(i,item){
               if(item.fields.Student_ID == "<? echo $_SESSION['userid']?>"){
                   $.each(item.fields.Pass_ID,function(i,item1){
                       ...
                       courseid = Course.records[Course_index].id;
                       ...
                       studentid = item.id;
                       console.log(Coursename,teachername,Year,section,passid);
                       plus_test = plus_test+" <tr><td>"+num+"</td><td>"+Coursename+"</td><td>"+teachername+"</td><td>"+Year+"</td><td>第"+section+"學期</td><td>"+
                       "<a href='commet_new.php?Year="+Year+"&section="+section+"&Coursename="+Coursename+"&teachername="+teachername+"&studentname="+studentname+"&studentdepart="+studentdepart+"&grade="+grade+"&studentid="+studentid+"&courseid="+courseid+"' class='view' title='write' data-toggle='tooltip'><i class='fas fa-comments'></i></a></td></tr>"
      ...
      <div class="container" style="margin-top:100px">
          <div class="table-wrapper">
              <div class="table-title">
                  <div class="row">
                      <div class="col-sm-7" style="text-align:right"><h2><b>修課通過一覽表</b></h2></div>
                      <!-- <div class="col-sm-4">
