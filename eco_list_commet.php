      ...
      <div class="container" style="margin-top:40px">
          <div class="table-wrapper">
              <div class="table-title">
                  <div class="row">
                      <div class="col-sm-15" style="text-align:center"><h2><b>經濟學</b></h2></div>
                      <!-- <div class="col-sm-4">
              ...
              <table class="table table-striped table-hover table-bordered" style="margin-top:30px">
                  ...
                  <tbody>
                      <tr>
                          ...
                          <td>2019-11-11</td>
                          <td>
  							              <a href="#" class="view" title="view" data-toggle="tooltip" onclick="window.location='commet_eco_view.php'"><i class="material-icons">&#xE417;</i></a>
